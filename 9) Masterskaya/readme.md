...
<head>
  <meta charset="utf-8"/>
  <title>heart_attack_risk_predict — README</title>
</head>
<body>

<h1>💓 heart_attack_risk_predict — Предсказание риска сердечных приступов</h1>

<p><strong>Кратко:</strong> репозиторий содержит pipeline ML и FastAPI-сервис для предсказания высокого/низкого риска сердечного приступа по медицинским и поведенческим данным.</p>
